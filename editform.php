        ...
        <form action="logica/botones.php" method="POST">
            ...
            <div class="col-md-4">
                ...
                <select id="maquinaria" class="form-select" name="maquinaria">
                    <option selected><?php echo $mostrar['maquinaria'] ?></option>
            ...
            <div class="col-md-4">
                ...
                <select id="tractores" class="form-select" name="tractores">
                    <option selected><?php echo $mostrar['tractores'] ?></option>
            ...
            <div class="col-md-2">
                ...
                <select id="chofer" class="form-select" name="chofer">
                    <option selected><?php echo $mostrar['chofer'] ?></option>
            ...
            <div class="col-md-3">
                ...
                <select id="motobomba" class="form-select" name="motobomba">
                    <option selected><?php echo $mostrar['motobomba'] ?></option>
            ...
            <div class="col-md-2">
                ...
                <select id="horas" class="form-select" name="horas">
                    <option selected><?php echo $mostrar['horas'] ?></option>
            ...
            <div class="col-md-4">
                ...
                <select id="predios" class="form-select" name="predios">
                    <option selected><?php echo $mostrar['predios'] ?></option>
            ...
            <input type="hidden" name="actualizarId" value="<?php echo $mostrar['id']; ?>">
